...
import { FiUsers, FiMessageSquare, FiVideo, FiActivity, FiLogOut, FiAlertTriangle, FiSlash } from 'react-icons/fi';
    ...
    <div className="min-h-screen bg-dark-900">
      ...
      <div className="bg-dark-800 border-b border-white/10 px-6 py-4 flex justify-between items-center sticky top-0 z-50">
        <div className="flex items-center gap-3">
          ...
          <div className="ml-4 px-2 py-1 rounded-full bg-green-500/20 border border-green-500/50 flex items-center gap-2 text-xs text-green-400">
